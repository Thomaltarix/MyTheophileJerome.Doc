...
def printUsage(exitCode):
    ...
    print("Usage:\n\
        ...
        \t\texpectedStdoutOutput: The expected stdout output of the program (String of filepath)\n\
        \t\texpectedStderrOutput: The expected stderr output of the program (String of filepath)")
    exit(exitCode.value)
